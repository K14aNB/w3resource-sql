/*
 Salespeople And Customers Not From Same City
 --------------------------------------------
...
--Write SQL query to find the salespeople who generated orders for their customers
--but are not located in the same city. Return ord_no, cust_name, customer_id (orders),
--salesman_id (orders)
SELECT
    o.ord_no,
    c.cust_name,
