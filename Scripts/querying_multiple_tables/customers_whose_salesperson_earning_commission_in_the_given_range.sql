/*
 Customers Whose Salesperson Earning Commission in Range of 12-14%
 -----------------------------------------------------------------
...
--Write SQL query to find the customers who are served by salespersons
--earning commission in the range 12-14% (both values included).
--Return cust_name as 'Customer' and city as 'City'.
SELECT
