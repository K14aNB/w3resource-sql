...
--Write SQL query to find all orders excluding those with ord_date '2012-09-10' and
--salesman_id higher than 5005 or purch_amt greater than 1000. Return ord_no, purch_amt,
