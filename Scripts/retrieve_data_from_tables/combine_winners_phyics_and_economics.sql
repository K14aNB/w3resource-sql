/*
Combine Winners (Physics 1970  & Economics 1971)
------------------------------------------------
...
--Write SQL query that combines the winners in Physics 1970 and Economics 1971
--Return the year, subject, winner, country and category.
--Method 1
SELECT *
